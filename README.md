...
- Migração SQL com tabelas, relacionamentos e políticas de Row Level Security (RLS).

## 🗺️ Próximos passos sugeridos

- Implementar autenticação com Supabase Auth (magic link ou SSO corporativo).
- Criar tabela `profiles` sincronizada com `auth.users` para armazenar departamento, cargo e avatar.
